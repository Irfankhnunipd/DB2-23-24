...
/**
 * Servlet implementation class DeleteCustomerDataServlet
 */
...
public class DeleteCustomerDataServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement pst = con.prepareStatement("DELETE from customer WHERE customer_name = ?");
		...
		pw.println("<br>");
		pw.println("<a href = 'CustomerList'> Customer List </a>");
